...
export default function DraggableLanyard({className = ""}) {
  return (
        ...
        <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          ...
          <group
            ...
            <mesh geometry={nodes.card.geometry}>
              <meshPhysicalMaterial map={material.map} map-anisotropy={16} clearcoat={1} clearcoatRoughness={0.15} roughness={0.3} metalness={0.5} />
            </mesh>
